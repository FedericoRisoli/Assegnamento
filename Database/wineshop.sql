...
--
-- Host: 127.0.0.1
-- Creato il: Mar 17, 2023 alle 11:53
...
(3, 'a', 'a', 21, 'test 1 52.5 \nfrancia corta 1 70.0 \n', 'a', '1800-01-01', '2023-02-23', 1, 1, '453.00', NULL),
(7, 'Agostino', 'Poggi', 0, 'francia corta 21 1337.7 \n', 'via Campus 1', '1800-01-01', '2023-02-23', 1, 0, '453.00', NULL),
(8, 'a', 'a', 0, 'test 1 52.5 \n', 'a', '1800-01-01', '2023-03-10', 1, 0, '10.00', NULL),
(9, 'a', 'a', 0, 'test 1 52.5 \nPink Desire 27 904.05 \nBarbaresco DOCG \"Montersino\" 1 50.0 \n', 'a', '1800-01-01', '2023-02-23', 1, 0, '2.00', NULL),
(10, 'a', 'a', 0, 'Francia Corta 17 238.738 \n', 'a', '1800-01-01', '2023-02-23', 1, 0, '2.00', NULL),
(11, '', '', 0, 'francia corta 30 2100.0', '', '1800-01-01', '2023-03-03', 1, 1, '0.00', NULL),
(12, 'a', 'a', 0, 'francia corta 1 70.0 \n', 'a', '1800-01-01', '2023-02-17', 1, 1, '0.00', NULL),
(13, '', '', 0, 'francia corta 30 2100.0', '', '1800-01-01', '2023-03-25', 1, 1, '250.00', NULL),
(14, 'a', 'a', 0, 'test 1 52.54 \n', 'a', '1800-01-01', '2023-02-17', 1, 1, '0.00', NULL),
(15, 'a', 'a', 0, 'test 1 52.57 \n', 'a', '1800-01-01', '2023-02-17', 1, 1, '0.00', NULL),
(16, 'a', 'a', 0, 'testa 1 50.25 \n', 'a', '1800-01-01', '2023-02-17', 1, 1, '0.00', NULL),
(17, 'a', 'a', 0, 'francia corta 1 70.05 \n', 'a', '1800-01-01', '2023-02-17', 1, 1, '0.00', NULL),
(18, '', '', 0, 'francia corta 30 2101.5', '', '1800-01-01', '2023-03-25', 1, 1, '250.00', NULL),
(19, 'a', 'a', 0, 'Francia Corta 1 15.75 \n', 'a', '1800-01-01', '2023-02-17', 1, 1, '0.00', NULL),
(20, '', '', 0, 'Francia Corta 15 236.25', '', '1800-01-01', '2023-03-25', 1, 1, '250.00', NULL),
(24, 'a', 'a', 21, 'test 1 52.69 \n', 'a', '2023-03-03', '2023-03-06', 1, 1, '52.69', NULL),
(25, 'null', 'null', 22, '[Francia Corta, 33]', 'ehsi', '2023-03-09', NULL, 0, 0, '0.00', NULL),
(26, 'null', 'null', 26, '[Francia Corta, 11]', 'ezz', '2023-03-09', NULL, 0, 0, '0.00', NULL),
(27, 'Tito', 'Fiorentino', 26, '[Francia Corta, 17]', 'qwerty', '2023-03-09', NULL, 0, 0, '0.00', NULL),
(28, 'Tito', 'Fiorentino', 26, 'Francia Corta 19 11.0\n', 'Eh si', '2023-03-09', '2023-03-16', 1, 0, '50.00', NULL),
(29, 'Tito', 'Fiorentino', 26, 'Francia Corta 16 11.0\n', 'cappolo', '2023-03-09', NULL, 0, 0, '0.00', NULL),
(30, 'a', 'a', 21, 'Barbaresco DOCG \"Montersino\" 18 485.91 \n', 'a', '2023-03-09', '2023-03-12', 1, 1, '485.91', NULL),
(31, 'a', 'a', 21, 'Barbaresco Meruzzano 19 649.64 \n', 'a', '2023-03-09', '2023-03-12', 1, 1, '649.64', NULL),
(32, 'Agostino', 'Poggi', 1, 'Francia Corta 15 11.0\n', 'zzz', '2023-03-09', '2023-03-25', 1, 0, '250.00', 26),
(33, '', '', 0, 'Barbaresco Meruzzano 15 578.85', '', '2023-03-17', '2023-03-25', 1, 1, '250.00', 26);
...
(1, 'admin', 'admin', 'admin', 'Agostino', 'Poggi', 'fhfusjfio', 'A.Poggi@unipr.it', '3333333333', 'via Campus 1', 3, 171),
(18, 'client', 'user', 'EZZ', 're', 'serg', 'srg', 'dsfg', 'sdfg', 'sdfg', 0, 0),
(21, 'client', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 0, 197),
(22, 'employee', 'emp', 'e', 'e', 'e', 'e', 'e', 'e', 'e', 1, 212),
...
(26, 'employee', 'Tito', 'tito', 'Tito', 'Fiorentino', 'MSNVMF86M68M045Q', 'fiorentino@gmail.com', '07201380537', 'Via Palermo, 12, 98040-Soccorso ME', 3, 85),
...
(34, 'client', 'aw', 'aw', 'aw', 'aw', 'aw', 'aw', 'aw', 'aw', 0, 0),
(35, 'client', 'sw', 'sw', 'sw', 'sw', 'sw', 'sw', 'sw', 'sw', 0, 0),
(36, 'client', 'uuuu', 'uuu', 'uuu', 'uuu', 'uuu', 'uu', 'uu', 'uu', 0, 0);
...
(1, 'francia corta', 'unipr', 'parma', 2022, 'rtewgserg', 'sergsdrgzxcv', 'Alta', 2, 0, 224),
...
(6, 'Barbaresco Meruzzano', 'Abrigo Orlando', 'Italia', 1995, 'Barbera', 'Frizzante, fruttato, bianco', 'Alta', 29, 1, 27),
